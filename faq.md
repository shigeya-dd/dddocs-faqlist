...
- [Autodiscovery Auto-Configuration](https://docs.datadoghq.com/agent/faq/auto_conf)
- [CERTIFICATE_VERIFY_FAILED error](https://docs.datadoghq.com/agent/faq/certificate_verify_failed-error)
- [Commonly Used Log Scrubbing Rules](https://docs.datadoghq.com/agent/faq/commonly-used-log-processing-rules)
