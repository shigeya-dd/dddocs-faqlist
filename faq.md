...
- [Agent v5 - Certificate Authority Update (2026)](https://docs.datadoghq.com/agent/faq/agent-5-sectigo-root-ca-rotation)
...
- [Why do I get a 429 Too Many Requests error when using the API?](https://docs.datadoghq.com/cloudcraft/faq/error-429-too-many-requests)
